...
import Field3D from '../../../src/scripts/model/Field3D.js'
import FieldView from '../../../src/scripts/model/FieldView.js'
...
(function () {
	...
	describe('FieldView', function () {
		...
		var div
		var dotView
		var options = applyObjectDefaults({}, defaultOptions)
		...
		beforeEach(function() {
			...
			dotView = new FieldView(window, document, field, options)
			div = dotView.div
			dotView.render()
		})
